...
# ## Stock Market Forecasting by Maithreyan S
...
# importing the data from koyfin
...
df1 = pd.read_csv('apple.csv' ,index_col=0, parse_dates=True)
stock=df1
...
# the model clearly captured close price seasonality. As we forecast further out into the future, it is natural for us to become less confident in our values. This is reflected by the confidence intervals generated by our model, which grow larger as we move further out into the future.
